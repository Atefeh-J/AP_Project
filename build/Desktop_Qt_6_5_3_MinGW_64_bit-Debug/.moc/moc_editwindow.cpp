...
struct qt_meta_stringdata_CLASSEditwindowENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSEditwindowENDCLASS = QtMocHelpers::stringData(
    "Editwindow",
    "readInfo",
    "",
    "gotowindow",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSEditwindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSEditwindowENDCLASS_t qt_meta_stringdata_CLASSEditwindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "Editwindow"
        QT_MOC_LITERAL(11, 8),  // "readInfo"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 10),  // "gotowindow"
        QT_MOC_LITERAL(32, 6)   // "choice"
    },
    "Editwindow",
    "readInfo",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEditwindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Editwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEditwindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEditwindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEditwindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Editwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEditwindowENDCLASS.stringdata0))
